...
<div class="container">
    <h1><i class='bx bxs-user'></i> Edit Customer</h1>
    <form action="Customer?action=update" method="post">
        ...
        <input type="tel" id="phone" name="phone" value="${customer.phone}" pattern="[0-9]{10,15}" required
        ...
        <select id="active" name="active">
            <option value="true" <c:if test="${customer.active}">selected</c:if>>Yes</option>
            <option value="false" <c:if test="${!customer.active}">selected</c:if>>No</option>
        </select>

        <button type="submit" class="submit-btn"><i class='bx bx-save'></i> Update Customer</button>
    </form>
